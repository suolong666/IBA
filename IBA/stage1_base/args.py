...
def parse_global_args(parser):
    ...
    parser.add_argument("--base_model", type=str, default="",help="basic model path")
    parser.add_argument("--c1_max_k", type=int, default=5, help="Maximum k for c1 refinement")
    parser.add_argument("--c1_k", type=int, default=2, help="k for c1 refinement")
    parser.add_argument("--c1_alphas", type=str, default="0.3,0.8", help="alphas for c1 refinement, separate by comma")
    parser.add_argument("--c1_enable_refine", action="store_true", default=False, help="whether enable c1 refinement")
    parser.add_argument("--c1_infer_use_cache", action="store_true", default=False, help="whether use cache during inference")
    ...
    parser.add_argument("--c1_tail_recurrence_gamma", type=float, default=0.5,
                        help="Gamma for tail recurrence: blending weight between raw and tail hidden states (0-1)")
    return parser
...
def parse_train_args(parser):
    ...
    parser.add_argument("--dataloader_num_workers", type=int, default=8,
                        help="Number of workers used by the training dataloader")
